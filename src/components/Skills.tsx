  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        tags: ["ETL", "Medallion Architecture", "Lakehouse", "Data Engineering"],
      },
      {
        name: "Matplotlib",
        icon: "matplotlibIcon",
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        tags: ["Version Control", "Branching", "Distributed"],
      },
      {
        name: "Gitlab",
        icon: "gitlabIcon",
      ...
      },
      {
        name: "BigQuery",
        icon: "bigqueryIcon",
        obtainedFrom: "Google Cloud Platform",
        description: "Serverless data warehouse for analytics at scale",
        tags: ["Data Warehouse", "SQL", "Cloud Analytics"],
      },
      {
        name: "Supabase",
        icon: "supabaseIcon",
        ...
        tags: ["Backend-as-a-Service", "PostgreSQL", "Real-time"],
      },
      {
        name: "SAP Signavio",
        ...
        tags: ["Process Modeling", "Business Analysis", "Workflow"],
      },
      {
        name: "Confluence",
        icon: "confluenceIcon",
        ...
        tags: ["Documentation", "Collaboration", "Knowledge Management"],
      },
    ],
  },
  {
